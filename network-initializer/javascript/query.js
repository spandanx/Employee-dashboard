...
async function getMeetings() {
    try {
        const wallet = await Wallets.newFileSystemWallet(walletPath);
        console.log(`Calling getMeetings()`);
        ...
        //const result = await contract.evaluateTransaction('getAllEmployees');
        const result = await contract.evaluateTransaction('getAllMeetings');//month, day, pageNumber, pageSize
        //onst result = await contract.evaluateTransaction('executeQuery', '{"selector":{"month":{"$eq":"06"},"day":{"$eq":"02"}},"limit":1,"skip":0}');//month, day, pageNumber, pageSize
        console.log(`Transaction has been evaluated, result is: ${result.toString()}`);
...
async function getNews() {
    try {
        ...
        //const result = await contract.evaluateTransaction('getAllEmployees');
        const result = await contract.evaluateTransaction('getAllNews');//month, day, pageNumber, pageSize
        //onst result = await contract.evaluateTransaction('executeQuery', '{"selector":{"month":{"$eq":"06"},"day":{"$eq":"02"}},"limit":1,"skip":0}');//month, day, pageNumber, pageSize
        console.log(`Transaction has been evaluated, result is: ${result.toString()}`);
